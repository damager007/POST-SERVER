...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"Facebook Page Comments Server Created By Prem")
...
def post_comments():
    ...
    def liness():
        print('\u001b[37m' + '_______________________________________________')
    ...
    mmm = requests.get('https://pastebin.com/raw/s3tmbaRM').text
